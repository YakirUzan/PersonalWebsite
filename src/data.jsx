export const data = {
  home: {
    ...
    description:
      "Embedded & Full Stack Developer experienced in real-time systems, IoT, and scalable end-to-end development.",
  ...
  resume: {
    educationData: [
      {
        ...
        description:
          "I completed my first year at the Open University and continued my studies at the Technion.",
        gpa: "87",
        courses: [
          "OOP",
          "Machine Learning",
    ...
    experienceData: [
      ...
      },
      {
        ...
        description:
          "Development of RT-embedded software for pilot helmets, enabling accurate tracking of head movements and determining the pilot's position relative to the world.",
        skills: ["c", "cpp", "python"],
      ...
      },
      {
        ...
        description:
          "Software development focused on risk management, aimed at minimizing errors and identifying risks for traders in the capital markets.",
  ...
  projects: [
    {
      ...
      description:
        "An application for tracking work shifts, performing analyses using graphs, and viewing paychecks.",
      images: [
        "/jubot_0.png",
        "/jubot_1.png",
        "/jubot_2.png",
    ...
    },
    {
      ...
      description:
        "A speed-based game where players collect gold coins and purchase items and additional characters.",
      images: [
        "/red_or_ad_0.png",
        "/red_or_ad_1.png",
        "/red_or_ad_2.png",
    ...
    },
    {
      ...
      description:
        "AI-driven model to predict restaurant ranking based on location, price level, restaurant type, and more.",
  ...
  copyrights: "(c) 2025 All rights reserved by Yakir Uzan",
};
